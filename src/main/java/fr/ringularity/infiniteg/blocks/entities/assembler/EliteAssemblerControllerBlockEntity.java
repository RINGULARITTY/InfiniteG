...
public class EliteAssemblerControllerBlockEntity extends AbstractAssemblerControllerBlockEntity {

    public EliteAssemblerControllerBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ELITE_ASSEMBLER_CONTROLLER_BE.get(), pos, state);
    }
