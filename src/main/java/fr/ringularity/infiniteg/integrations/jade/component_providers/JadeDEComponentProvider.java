...
public enum JadeDEComponentProvider implements IBlockComponentProvider {
    INSTANCE;

    private static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(InfiniteG.MOD_ID, "infiniteg_de_component_provider");
    ...
    private static final ResourceLocation PROGRESS_BAR_FILL = ResourceLocation.fromNamespaceAndPath(InfiniteG.MOD_ID, "jade/de_bar");
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor blockAccessor, IPluginConfig config) {
        ...
        tooltip.add(JadeUI.progress(1, PROGRESS_BAR_BASE, PROGRESS_BAR_FILL, 300, 13, Component.literal(BigDecimalFormat.format(deQuantity) + " Dark Energy"), JadeUI.progressStyle()));
