...
public class CompactorMenu extends AbstractContainerMenu {
    ...
    public CompactorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.COMPACTOR_MENU.get(), pContainerId);
        this.be = ((CompactorBlockEntity) entity);
